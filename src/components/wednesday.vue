<template>
  <div class="container">
    ...
    >
      ...
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('1')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('2')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('3')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('4')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('5')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('6')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('7')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('8')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('9')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('10')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('11')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('12')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[2].wednesday.includes('13')">
        〇
      </div>
      <div class="col" v-else>✕</div>
    </div>
