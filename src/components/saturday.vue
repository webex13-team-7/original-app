  ...
  <div class="container m-5 p-5 shadow">
    ...
    >
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('1')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('2')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('3')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('4')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('5')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('6')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('7')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('8')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('9')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('10')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('11')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('12')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[5].saturday.includes('13')"
        v-bind:class="
...
export default {
  ...
  methods: {
    ...
    submit() {
      setDoc(doc(db, "sifts" ,"saturday"), {
        saturday1: this.unko1,
        saturday2: this.unko2,
        saturday3: this.unko3,
        saturday4: this.unko4,
        saturday5: this.unko5,
        saturday6: this.unko6,
        saturday7: this.unko7,
        saturday8: this.unko8,
        saturday9: this.unko9,
        saturday10: this.unko10,
        saturday11: this.unko11,
