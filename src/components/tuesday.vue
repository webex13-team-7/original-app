  ...
  <div class="container m-5 p-5 shadow">
    ...
    >
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('1')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('2')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('3')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('4')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('5')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('6')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('7')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('8')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('9')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('10')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('11')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('12')"
        v-bind:class="
      ...
      <div
        ...
        v-if="scheduledata.schedule[1].tuesday.includes('13')"
        v-bind:class="
  ...
  methods: {
    ...
    submit() {
      setDoc(doc(db, "sifts", "tuesday"), {
        ...
        tuesday8: this.unko8,
        tuesday9: this.unko9,
        tuesday10: this.unko10,
        tuesday11: this.unko11,
        tuesday12: this.unko12,
        tuesday13: this.unko13,
      })
    },
  },
  computed: {
