<template>
  <div class="container">
    ...
    >
      ...
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('1')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('2')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('3')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('4')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('5')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('6')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('7')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('8')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('9')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('10')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('11')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('12')">〇</div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[1].tuesday.includes('13')">〇</div>
      <div class="col" v-else>✕</div>
    </div>
  </div>
</template>
