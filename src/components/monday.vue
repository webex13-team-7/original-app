<template>
  <div class="container">
    ...
    >
      ...
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('1')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('2')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('3')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('4')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('5')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('6')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('7')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('8')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('9')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('10')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('11')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('12')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[0].monday.includes('13')">
        〇
      </div>
      <div class="col" v-else>✕</div>
    </div>
