<template>
  <div class="container">
    ...
    >
      ...
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('1')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('2')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('3')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('4')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('5')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('6')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('7')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('8')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('9')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('10')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('11')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('12')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[6].sunday.includes('13')">
        〇
      </div>
      <div class="col" v-else>✕</div>
    </div>
