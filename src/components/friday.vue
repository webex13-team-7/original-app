<template>
  <div class="container">
    ...
    >
      ...
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('1')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('2')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('3')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('4')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('5')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('6')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('7')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('8')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('9')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('10')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('11')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('12')">
        〇
      </div>
      <div class="col" v-else>✕</div>
      <div class="col" v-if="scheduledata.schedule[4].friday.includes('13')">
        〇
      </div>
      <div class="col" v-else>✕</div>
    </div>
